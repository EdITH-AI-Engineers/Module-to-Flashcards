...
def build_graph(triples: list[dict], source_file: Path, model_name: str) -> dict:
...
def main() -> None:
    ...
    text = clean_text(args.input.read_text(encoding="utf-8-sig", errors="replace"))
    ...
    graph = build_graph(triples, args.input, args.model)
